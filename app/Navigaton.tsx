...
const Navigaton = () => {
  return (
    <div className="relative bg-slate-800 h-16 flex justify-between items-center px-5 lg:px-16">
      <h1 className="text-white text-3xl font-bold">Imran</h1>
      <ul className="absolute -translate-x-[100%] lg:-translate-x-0 flex text-slate-300 text-lg lg:text-xl">
